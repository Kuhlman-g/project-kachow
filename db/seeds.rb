...
# review4 = Review.create(pizza: pizza2, name: 'Uncured Pepperoni', rating: 95, body: "Best peppersoni on a frozen pizza ever! Crust and other toppings are epic!")
# review5 = Review.create(pizza: pizza2, name: 'Uncured Pepperoni', rating: 90, body: "Good choice as always from this brand.")
# review6 = Review.create(pizza: pizza5, name: 'Veggie Supreme', rating: 80, body: "Solid flavor. A great vegetarian option.")
